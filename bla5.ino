...
volatile double Pref = 0.3; //potência de referência  da CPL em p.u.
...
void tratar_interrupcao()
{
  ...
  { open_loop();
    mostrar_sinal();}
  if ((malha == 2) && (cpl == 0) ) /*Call the function to execute chosen control strategy*/
  { PWM->PWM_CH_NUM[3].PWM_CDTY = 100 - 0; closed_loop();
    mostrar_sinal();}
  if (cpl == 1) /*Call the function to execute chosen control strategy*/
  { 
    entra_cpl();
    mostrar_sinal();}    
  }
...
void open_loop() /*open loop */
{
  ...
  //PWM->PWM_CH_NUM[3].PWM_CDTY = 100 - 0;
...
{
  if(vp == 1){ ttt = ttt+1;}
      if((ttt> 0) & (ttt<2500))      {Pref = 0.4;}
      if((ttt>= 2500) & (ttt<5000))  {Pref = 0.5;}      
      if((ttt>= 5000) & (ttt<7500))  {Pref = 0.3;}      
      if((ttt>= 7500) & (ttt<10000)) {Pref = 0.2;}           
      if((ttt>= 10000) & (ttt<12500)){Pref = 0.1;}
      if((ttt>= 12500) & (ttt<15000)){Pref = 0.3; volatile int vp = 0;}                       
    
    eCpl[0] = Pref - (Vc_cpl*Vc_cpl)/(5.0*Pb);  
 ...
 void closed_loop() /*closed mash*/
 {
  e[0] = vref - Vc_buck;
   ...
   if(vt == 1){ tt = tt+1;
      if((tt> 0) & (tt<2500))       {vref = 7.0;}
      if((tt>= 2500) & (tt<5000))   {vref = 8.0;}      
      if((tt>= 5000) & (tt<7500))   {vref = 6.0;}      
      if((tt>= 7500) & (tt<10000))  {vref = 5.0;}           
      if((tt>= 10000) & (tt<12500)) {vref = 4.0;}
      if((tt>= 12500) & (tt<15000)) {vref = 6.0; volatile int vt = 0;}
//      if((tt> 15000))               {volatile int tt = 0; vt = 0;}    
  }
